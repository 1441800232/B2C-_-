<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\wamp64\www\shop\public/../application/index\view\index\index.htm";i:1694939809;s:67:"D:\wamp64\www\shop\public/../application/index\view\common\head.htm";i:1694939809;s:69:"D:\wamp64\www\shop\public/../application/index\view\common\footer.htm";i:1694164482;}*/ ?>
<!doctype html>
<html>
<head>
  ...
  <link rel="shortcut icon" href="<?php echo $configs['logo']; ?>">
  ...
  <script type="text/javascript" src="__index__/js/jquery-1.9.1.min.js"></script><script type="text/javascript" src="__index__/js/jquery.json.js"></script>
...
<div class="top-banner" style="background: rgb(252,215,229) none repeat scroll 0% 0%;">
  ...
  <div class="content" style="min-height: 974px;"><div class="visual-item" data-mode="lunbo" data-purebox="banner" data-li="1" data-length="5" ectype="visualItme" style="display: block;" data-diff="0">
    ...
    <div class="view">
      <div class="banner home-banner">
        <div class="bd">
          <ul data-type="range">
            <?php if(is_array($alternateImgRes) || $alternateImgRes instanceof \think\Collection || $alternateImgRes instanceof \think\Paginator): $i = 0; $__LIST__ = $alternateImgRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$alternateImg): $mod = ($i % 2 );++$i;?>
            <li style="background:url(__UPADMIN__/<?php echo $alternateImg['img_src']; ?>) center center no-repeat;"><div class="banner-width"><a href="<?php echo $alternateImg['link_url']; ?>" style="height:500px;" target="_blank"></a></div></li>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            ...
            <div class="insertVipEdit" data-mode="insertVipEdit">
              ...
              <div class="vip-item">
                ...
                <div class="con">
                  <!--公告-->
                  <ul>
                    <?php if(is_array($noticeRes) || $noticeRes instanceof \think\Collection || $noticeRes instanceof \think\Paginator): $i = 0; $__LIST__ = $noticeRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$arts): $mod = ($i % 2 );++$i;?>
                    <li><a href="<?php echo url('index/Article/index',array('id'=>$arts['id'])); ?>" target="_blank"><?php echo $arts['title']; ?></a></li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                  </ul>
                  <!--促销-->
                  <ul style="display:none;">
                    <?php if(is_array($promotionRes) || $promotionRes instanceof \think\Collection || $promotionRes instanceof \think\Paginator): $i = 0; $__LIST__ = $promotionRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$arts): $mod = ($i % 2 );++$i;?>
                    <li><a href="<?php echo url('index/Article/index',array('id'=>$arts['id'])); ?>" target="_blank"><?php echo $arts['title']; ?></a></li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                  </ul>
                </div>
        ...
        <div class="brand-channel clearfix" id="h-brand_0" data-type="range" data-lift="品牌">
          ...
          <div ectype="homeBrand">
            ...
            <div class="brand-list" id="recommend_brands">
              <a href="javascript:void(0);" ectype="changeBrand" class="refresh-btn"><i class="iconfont icon-rotate-alt" id="refresh-btn"></i><span>换一批</span></a>
            </div>
          </div>
            ...
            <div class="floor-hd" ectype="floorTit">
              ...
              <div class="hd-tags">
                <ul>
                  ...
                  <li data-catgoods="" class="first" ectype="floor_cat_content" data-flooreveval="0"
                      data-visualhome="1" data-floornum="6" data-id="<?php echo $v1['id'];?>">
              ...
              <div class="bd-left">
                <div class="floor-left-slide">
                  <div class="bd">
                    <!--循环展示A轮播图-->
                    <ul>
                      <?php if(isset( $v['leftImg']['A'])):foreach($v['leftImg']['A'] as $k1 => $v1):?>
                      <li><a target="_blank"  href="<?php echo $v1['link_url'];?>"><img src="__UPADMIN__/<?php echo $v1['img_src'];?>"></a></li>
                ...
                <div class="floor-left-adv">
                  <!--循环展示B轮播图-->
                  <?php if(isset( $v['leftImg']['B'][0]['img_src'])):?>
                  <a href="<?php echo $v['leftImg']['B'][0]['link_url']?>" target="_blank"><img src="__UPADMIN__/<?php echo $v['leftImg']['B'][0]['img_src']?>"></a>
                  <?php endif;?>

                  <!--循环展示C轮播图-->
                  <?php if(isset( $v['leftImg']['B'][0]['img_src'])):?>
                  <a href="<?php echo $v['leftImg']['C'][0]['link_url'];?>" target="_blank"><img src="__UPADMIN__/<?php echo $v['leftImg']['C'][0]['img_src'];?>"></a>
                  <?php endif;?>
                </div>
                  ...
                  <div class="f-r-main" ectype="floor_cat_347">
                    <ul class="p-list">
                      ...
                      <li class="opacity_img">
                        <div class="product">
                          <div class="p-img">
                            <a href="" target="_blank"><img src="__UPADMIN__/<?php echo $v1['mid_thumb'];?>" width="140" height="140"></a>
                          </div>
                          <div class="p-name">
                            <a href="" title="<?php echo $v1['goods_name'];?>">
                              <?php echo $v1['goods_name'];?>
                            </a>
                          </div>
                  ...
                  <div class="f-r-main" ectype="floor_cat_347" >
                    <ul class="p-list">
                      ...
                      <li class="opacity_img">
                        <div class="product">
                          <div class="p-img">
                            <a href="" target="_blank"><img src="__UPADMIN__/<?php echo $v2['mid_thumb'];?>" width="140" height="140"></a>
                          </div>
                          <div class="p-name">
                            <a href="goods.php?id=801" title="<?php echo $v2['goods_name'];?>">
              ...
              <div class="floor-fd-brand clearfix">
                ...
                <div class="item">
                  <a href="<?php echo $v1['brand_url']?>" target="_blank">
                    ...
                    <div class="imh"><img src="__UPADMIN__/<?php echo $v1['brand_img']?>" title="<?php echo $v1['brand_name']?>"></div>
                    <div class="link"></div>
                  </a>
                </div>
                <?php endforeach;?>
          ...
          <ul>
            ...
            <li class="opacity_img">
              <a href="goods.php?id=620" target="_blank">
                <div class="p-img"><img src="__UPADMIN__/<?php echo $goods['mid_thumb']; ?>"></div>
                <div class="p-name" title="<?php echo $goods['goods_name']; ?>"><?php echo $goods['goods_name']; ?></div>
                <div class="p-price">
                  <div class="shop-price">
                    <em>¥</em><?php echo $goods['shop_price']; ?>
                  </div>
