<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"D:\wamp64\www\shop\public/../application/index\view\article\Article.htm";i:1684232731;s:67:"D:\wamp64\www\shop\public/../application/index\view\common\head.htm";i:1684912928;s:72:"D:\wamp64\www\shop\public/../application/index\view\common\cate_left.htm";i:1684232731;s:69:"D:\wamp64\www\shop\public/../application/index\view\common\footer.htm";i:1684232731;}*/ ?>
<!doctype html>
<html>
<head>
	...
	<dl class="article-menu">
		...
		<dd class="am-c">
			<div class="menu-item active">
				...
				<?php if($helpCates): ?>
				<ul class="item-bd">
					<?php if(is_array($helpCates) || $helpCates instanceof \think\Collection || $helpCates instanceof \think\Paginator): $i = 0; $__LIST__ = $helpCates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?>
					<li><a href="<?php echo url('index/Cate/index',array('id'=>$cate['id'])); ?>"><?php echo $cate['cate_name']; ?></a></li>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</ul>
				<?php endif; ?>
			</div>
		...
		<!-- 普通分类 -->
		<dd class="am-c">
			<?php if(is_array($comCates) || $comCates instanceof \think\Collection || $comCates instanceof \think\Paginator): $i = 0; $__LIST__ = $comCates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?>
			<div class="menu-item active">
				<!---传递（发送）一个id过去-->
				<div class="item-hd"><a href="<?php echo url('index/Cate/index',array('id'=>$cate['id'])); ?>"><?php echo $cate['cate_name']; ?></a><i class="iconfont icon-down"></i></div>
				<!--如果你有子栏目我就循环你的栏目-->
				...
				<ul class="item-bd">
					...
					<li><a href="<?php echo url('index/Cate/index',array('id'=>$children['id'])); ?>"><?php echo $children['cate_name']; ?></a></li>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</ul>
				<?php endif; ?>
			</div>
        ...
        <div class="article-main">
            <div class="am-hd">
                ...
                <div class="extra">
    		        ...
    		        <i>&gt;</i>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    <span><?php echo $atrs['title']; ?></span>
                </div>
            </div>
            <div class="am-bd">
                <div class="article-words">
                    <?php echo $atrs['content']; ?>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="__index__/js/jquery.SuperSlide.2.1.1.js"></script><script type="text/javascript" src="__index__/js/dsc-common.js"></script>
<script type="text/javascript">
$(function(){
