<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\wamp64\www\shop\public/../application/admin\view\category\edit.htm";i:1684898873;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1684232731;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1684822925;}*/ ?>
<!DOCTYPE html>
<html>
...
<!--                                                    如果当前栏目的pid 等于我们现在 正在循环的某一个id的话那么就是我们当前栏目的上级栏目   selected="selected"选定-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="cate_name" name="cate_name" value="<?php echo $Categorys['cate_name']; ?>" required="" type="text">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control"  value="<?php echo $Categorys['iconfont']; ?>" placeholder="" name="iconfont"  type="text" />
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="radio" style="float:left; padding-right:12px;">
                                                    <label>
                                                        <input name="show_cate" value="1" <?php if($Categorys['show_cate'] == 1): ?>  checked="checked" <?php endif; ?> type="radio" class="inverted" >
                                                        <span class="text">是 </span>
                                                    </label>
                                                </div>
                                                <div class="radio" style="float:left; padding-right:12px;">
                                                    <label>
                                                        <input name="show_cate" value="0" <?php if($Categorys['show_cate'] == 0): ?>  checked="checked" <?php endif; ?>  type="radio" class="inverted" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <img src="__UPADMIN__/<?php echo $Categorys['cate_img']; ?>" height="70px">
                                                <?php else: ?>
                                                暂无图片
                                                <?php endif; ?>
                                            </div>
