<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\wamp64\www\shop\public/../application/member\view\account\login.htm";i:1685520284;}*/ ?>
...
<title>用户中心_大商创-免费B2B2C商城系统，免费多商户商城系统，多店铺商城系统，企业级电商系统免费下载_模板堂出</title>
...
<div class="login">
    ...
    <div class="container">
        <div class="login-wrap">
                        ...
                        <div class="form">
                            <form name="formLogin" action="user.php" method="post" onSubmit="userLogin();return false;">
                                ...
                                <div class="item item-button">
                                    <input type="hidden" name="dsc_token" value="d181014a3312a8a86c67ccff723ac5fd" autocomplete="off" />
                                    <input type="hidden" name="act" value="act_login" autocomplete="off" />
                                    <input type="hidden" name="back_act" value=".%2Findex.php" autocomplete="off" />
            ...
            <a class="login-banner" href="https://www.dscmall.cn/" target="_blank" style="background:url(__index__/img/1488936109167439630.jpg) center center no-repeat;"></a>
