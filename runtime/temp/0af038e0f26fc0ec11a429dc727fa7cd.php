<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\wamp64\www\shop\public/../application/member\view\account\login.htm";i:1694164483;}*/ ?>
                    ...
                    <div class="login-box">
                        ...
                        <div class="form">
                            <form name="formLogin" action="" method="post" onSubmit="userLogin();return false;">
                                ...
                                <a href="<?php echo url('member/account/getpassword'); ?>" class="notpwd gary">忘记密码？</a>
                            </form>
                        </div>
                    </div>
                </div>
