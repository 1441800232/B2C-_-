<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"D:\wamp64\www\shop\public/../application/admin\view\nav\add.htm";i:1684232731;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1694164483;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1684912930;}*/ ?>
<!DOCTYPE html>
<html>
                                    ...
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" role="form" action="" method="post"
                                            ...
                                            <div class="form-group">
                                                <label for="username"
                                                    class="col-sm-2 control-label no-padding-right">导航名称</label>
                                                <div class="col-sm-6">
                                                    <input class="form-control" id="nav_name" placeholder=""
                                                        name="nav_name" required="" type="text">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <label for="username"
                                                    class="col-sm-2 control-label no-padding-right">导航地址</label>
                                                <div class="col-sm-6">
                                                    <input class="form-control" placeholder="" name="nav_url"
                                                        type="text">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="username"
                                                    class="col-sm-2 control-label no-padding-right">新标签打开</label>
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="radio" style="float:left; padding-right:12px;">
                                                        <label>
                                                            <input name="open" value="2" type="radio"
                                                                class="inverted">
                                            ...
                                            <div class="form-group">
                                                <label for="username"
                                                       class="col-sm-2 control-label no-padding-right">导航位置</label>
                                                <div class="col-sm-6">
                                                    <select name="pos">
                                                        <option value="">请选择</option>
                                                        <option value="top">顶部</option>
                                                        <option value="mid">中间</option>
                                                        <option value="bottom">低部</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
