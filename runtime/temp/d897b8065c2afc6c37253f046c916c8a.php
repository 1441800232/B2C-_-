<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\wamp64\www\shop\public/../application/admin\view\auth_group\list.htm";i:1697280438;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1697091390;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1697277080;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<button type="button" tooltip="添加用户组" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('AuthGroup/add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <label>
                                    <input id="<?php echo $authGroup['id']; ?>"
                                           <?php if($authGroup['status'] == 1): ?> checked="checked"
                                           <?php endif; ?>
                                            class="checkbox-slider colored-darkorange" type="checkbox"
                                            onclick="changestasus(this)" >
                                    <span class="text" style="cursor:pointer"></span>
                                </label>

                            </td>                                <td align="center">
                                    <a href="<?php echo url('AuthGroup/edit',array('id'=>$authGroup['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('AuthGroup/del',array('id'=>$authGroup['id'])); ?>')" class="btn btn-danger btn-sm shiny">
    ...
    <script type="text/javascript">
        ...
        function changestasus(o){
            var id=$(o).attr("id");
            $.ajax({
                type:'POST',
                dataType:'json',
                data:{id:id},
                url:"<?php echo url('AuthGroup/changestasus'); ?>",
