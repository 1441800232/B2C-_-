<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\wamp64\www\shop\public/../application/admin\view\category_words\edit.htm";i:1684232731;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1684232731;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1684822925;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('categoryWords/lst'); ?>">关联词管理</a>
                    </li>
                    <li class="active">修改关联词</li>
                </ul>
            </div>
            <!-- /Page Breadcrumb -->
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-blue">
                                <span class="widget-caption">新增关联词</span>
                            </div>
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                                        <!--   enctype意思是可以上传图片-->
                                        <input type="hidden" name="id" value="<?php echo $categoryWords['id']; ?>">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="category_id">
                                                    ...
                                                    <!--获取和传输顶级栏目-->
                                                    <option <?php if($categoryWords['category_id'] == $cate['id']): ?> selected="selected" <?php endif; ?> value="<?php echo $cate['id']; ?>"><?php echo $cate['cate_name']; ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="" placeholder="" name="word" value="<?php echo $categoryWords['word']; ?>" required="" type="text">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="" value="<?php echo $categoryWords['link_url']; ?>" name="link_url" type="text">
                                            </div>
                                        </div>
