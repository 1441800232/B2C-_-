<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"D:\wamp64\www\shop\public/../application/admin\view\conf\edit.htm";i:1684232731;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1684920272;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1684912930;}*/ ?>
<!DOCTYPE html>
<html>
                                ...
                                <div id="horizontal-form">
                                    ...
                                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" value="<?php echo $confs['cname']; ?>"  placeholder="" name="cname" required="" type="text">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" value="<?php echo $confs['ename']; ?>" placeholder="" name="ename" required="" type="text">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="form_type" >
                                                    <option <?php if($confs['form_type'] == 'input'): ?> selected="checked" <?php endif; ?> value="input">input</option>
                                                    <option <?php if($confs['form_type'] == 'radio'): ?> selected="checked" <?php endif; ?> value="radio">radio</option>
                                                    <option <?php if($confs['form_type'] == 'checkbox'): ?> selected="checked" <?php endif; ?> value="checkbox">checkbox</option>
                                                    <option <?php if($confs['form_type'] == 'textarea'): ?> selected="checked" <?php endif; ?> value="textarea">textarea</option>
                                                    <option <?php if($confs['form_type'] == 'select'): ?> selected="checked" <?php endif; ?> value="select">select</option>
                                                    <option <?php if($confs['form_type'] == 'file'): ?> selected="checked" <?php endif; ?> value="file">file</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="conf_type">
                                                    <option <?php if($confs['conf_type'] == 'input'): ?> checked="店铺配置" <?php endif; ?> value="1">店铺配置</option>
                                                    <option <?php if($confs['conf_type'] == 'input'): ?> checked="商品配置" <?php endif; ?> value="2">商品配置</option>
                                                </select>
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="" value="<?php echo $confs['value']; ?>" name="value" type="text">
                                            </div>
