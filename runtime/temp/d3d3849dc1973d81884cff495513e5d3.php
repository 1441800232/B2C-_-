<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\wamp64\www\shop\public/../application/admin\view\recpos\list.htm";i:1694164484;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1697091390;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1697277080;}*/ ?>
<!DOCTYPE html>
<html>
...
<!--                    </a>-->
    ...
    <!-- /Sidebar Menu -->
            ...
            <div class="page-content">
                ...
                <!-- Page Body -->
                <div class="page-body">                   
                    <button type="button" tooltip="添加商品推荐位" 
                    class="btn btn-sm btn-azure btn-addon"onClick="javascript:window.location.href = '<?php echo url('recpos/add'); ?>'">
                                    ...
                                    <div class="flip-scroll">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td align="center"><?php echo $recpos['id']; ?></td>
                                                    <td align="center"><?php echo $recpos['rec_name']; ?></td>
                                                    ...
                                                    <td align="center">
                                                        ...
                                                        <a href="<?php echo url('edit',array('id'=>$recpos['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                            <i class="fa fa-edit"></i> 编辑
                                                        </a>
                                                        <!-- 用url 访问到控制器里的del的方法传递一个值下面的id   -->
                                                        <a href="#"
                                                            onClick="warning('确实要删除吗', '<?php echo url('del',array('id'=>$recpos['id'])); ?>')"
