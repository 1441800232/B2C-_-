<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\wamp64\www\shop\public/../application/admin\view\brand\edit.htm";i:1684232731;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1684232731;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1684822925;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                ...
                                <div class="widget-body">
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" role="form" action="" method="post"
                                            ...
                                            <!--   enctype意思是可以上传图片-->
                                            <input type="hidden" name="id" value="<?php echo $brands['id']; ?>"> <!-- 传递id值 -->
                                            <div class="form-group">
                                                ...
                                                <!--在brand的控制器里把定义edit的方法里
                                                 定义的值传递， 定义了一个$brands 
                                                 传递brand_name在数据库里的值-->
                                                    <input class="form-control" id="brand_name" placeholder="" value="<?php echo $brands['brand_name']; ?>"
                                                        name="brand_name" required="" type="text">
                                                </div>
                                                <p class="help-block col-sm-4 red">* 必填</p>
                                            </div>
                                            <div class="form-group">
                                                <label for="username"
                                                    class="col-sm-2 control-label no-padding-right">品牌网站</label>
                                                <div class="col-sm-6">
                                                    <input class="form-control" placeholder="" name="brand_url" value="<?php echo $brands['brand_url']; ?>"
                                                        type="text">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <textarea class="form-control" name="brand_describe">
                                                        <?php echo $brands['brand_describe']; ?>
                                                    </textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                   ...
                                                   <?php if($brands['brand_img'] != 0): ?>
                                                    <img src="__UPADMIN__/<?php echo $brands['brand_img']; ?>" height="30">
                                                   <?php else: ?>
                                                   暂无图片
                                                   <?php endif; ?>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="radio" style="float:left; padding-right:12px;">
                                                        <label>
                                                            <input name="brand_status" value="1" type="radio"
                                                                checked="checked">
                                                    ...
                                                    <div class="radio" style="float:left; padding-right:12px;">
                                                        <label>
                                                            <input name="brand_status" value="" type="radio"
                                                                class="inverted">
