<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\wamp64\www\shop\public/../application/admin\view\alternate_img\edit.htm";i:1684824509;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1684232731;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1684822925;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo url('alternate_img/lst'); ?>">轮播图管理</a>
                        </li>
                                ...
                                <div class="widget-body">
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" role="form" action="" method="post"
                                            ...
                                            <!--   enctype意思是可以上传图片-->
                                            <input type="hidden" name="id" value="<?php echo $alternate_imgs['id']; ?>"> <!-- 传递id值 -->
                                            <div class="form-group">
                                                <label for="username"
                                                    class="col-sm-2 control-label no-padding-right">轮播图名称</label>
                                                <div class="col-sm-6">                                                                  
                                                <!--在brand的控制器里把定义edit的方法里
                                                 定义的值传递， 定义了一个$brands 
                                                 传递brand_name在数据库里的值-->
                                                    <input class="form-control" id="title" placeholder="" value="<?php echo $alternate_imgs['title']; ?>"
                                            ...
                                            <div class="form-group">
                                                <label for="username"
                                                    class="col-sm-2 control-label no-padding-right">轮播图网站</label>
                                                <div class="col-sm-6">
                                                    <input class="form-control" placeholder="" name="link_url" value="<?php echo $alternate_imgs['link_url']; ?>"
                                                        type="text">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="brand_img"
                                                    class="col-sm-2 control-label no-padding-right">轮播图片</label>
                                                <div class="col-sm-6">
                                                    <input name="img_src" type="file">
                                                   <?php if($alternate_imgs['img_src'] != 0): ?>
                                                    <img src="__UPADMIN__/<?php echo $alternate_imgs['img_src']; ?>" height="30">
                                                   <?php else: ?>
                                                   暂无图片
                                                   <?php endif; ?>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="radio" style="float:left; padding-right:12px;">
                                                        <label>
                                                            <input class="inverted" name="status" value="1" type="radio" if condition="$alternate_imgs['status'] eq 0"}
                                                                   checked="checked" {/if}>
                                                    ...
                                                    <div class="radio" style="float:left; padding-right:12px;">
                                                        <label>
                                                            <input name="status" value="0" type="radio" <?php if($alternate_imgs['status'] == 0): ?>
