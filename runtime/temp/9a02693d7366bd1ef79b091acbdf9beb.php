<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"D:\wamp64\www\shop\public/../application/admin\view\conf\list.htm";i:1684232731;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1687179963;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1684912930;}*/ ?>
<!DOCTYPE html>
<html>
...
<!--                    </a>-->
    ...
    <!-- /Sidebar Menu -->
            ...
            <div class="page-content">
                ...
                <!-- Page Body -->
                <div class="page-body">                   
                    <button type="button" tooltip="添加品牌" class="btn btn-sm btn-azure btn-addon"onClick="javascript:window.location.href = '<?php echo url('Conf/add'); ?>'">
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <?php if(is_array($confRes) || $confRes instanceof \think\Collection || $confRes instanceof \think\Paginator): $i = 0; $__LIST__ = $confRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$conf): $mod = ($i % 2 );++$i;?>
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <input type="text" name="sort[<?php echo $conf['id']; ?>]" style="width: 60px; text-align:center;" value="<?php echo $conf['sort']; ?>" />
                                                    </td>
                                                    <td align="center">
                                                        ...
                                                        <a href="#"
                                                            onClick="warning('确实要删除吗', '<?php echo url('del',array('id'=>$conf['id'])); ?>')"
                                            ...
                                            <tr>
                                                <td colspan="9" align="right" style="padding-right: 19.5%;">
