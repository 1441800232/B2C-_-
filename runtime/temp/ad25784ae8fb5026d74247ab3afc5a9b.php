<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"D:\wamp64\www\shop\public/../application/admin\view\nav\list.htm";i:1684825136;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1697091390;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1697277080;}*/ ?>
<!DOCTYPE html>
<html>
...
<!--                    </a>-->
    ...
    <!-- /Sidebar Menu -->
            ...
            <div class="page-content">
                ...
                <!-- Page Body -->
                <div class="page-body">                   
                    <button type="button" tooltip="添加导航" 
                    class="btn btn-sm btn-azure btn-addon"onClick="javascript:window.location.href = '<?php echo url('Nav/add'); ?>'">
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center"><input type="text" name="sort[<?php echo $nav['id']; ?>]" value="<?php echo $nav['sort']; ?>" style="width: 60px ; text-align: center"></td>
                                                    <td align="center"><?php echo $nav['nav_name']; ?></td>
                                                    <!--target  在新的标签中打开-->
                                                    <td>
                                                        <a href="<?php echo $nav['nav_url']; ?>" target="_blank"><?php echo $nav['nav_url']; ?></a>
                                                    </td>
                                                    <td align="center">
                                                        <?php if($nav['open'] == 1): ?>
                                                        是
                                                    ...
                                                    <td align="center">
                                                        <a href="<?php echo url('edit',array('id'=>$nav['id'])); ?>"
                                                            class="btn btn-primary btn-sm shiny">
                                                            <i class="fa fa-edit"></i> 编辑
                                                        </a>
                                                        <!-- 用url 访问到控制器里的del的方法传递一个值下面的id   -->
                                                        <a href="#"
                                                            onClick="warning('确实要删除吗', '<?php echo url('del',array('id'=>$nav['id'])); ?>')"
