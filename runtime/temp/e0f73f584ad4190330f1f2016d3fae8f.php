<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"D:\wamp64\www\shop\public/../application/admin\view\alternate_img\add.htm";i:1684823381;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1684232731;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1684822925;}*/ ?>
<!DOCTYPE html>
<html>
                                    ...
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" role="form" action="" method="post"
                                            ...
                                            <div class="form-group">
                                                <label for="username"
                                                    class="col-sm-2 control-label no-padding-right">轮播图标题</label>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <label for="username"
                                                    class="col-sm-2 control-label no-padding-right">轮播图链接地址</label>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <label for="brand_img"
                                                    class="col-sm-2 control-label no-padding-right">轮播图图片</label>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="radio" style="float:left; padding-right:12px;">
                                                        <label>
                                                            <input name="status" value="" type="radio"
                                                                class="inverted">
