<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\wamp64\www\shop\public/../application/admin\view\recpos\edit.htm";i:1684232817;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1684232731;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1684370942;}*/ ?>
<!DOCTYPE html>
<html>
                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post"
                                        ...
                                        <!--   enctype意思是可以上传图片-->
                                        <input type="hidden" name="id" value="<?php echo $recpos['id']; ?>"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control"  name="rec_name" value="<?php echo $recpos['rec_name']; ?>" required="" type="text">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="radio" style="float:left; padding-right:12px;">
                                                    <label>
                                                        <input <?php if($recpos['rec_type'] == 1): ?> checked="checked" <?php endif; ?> name="rec_type" value="1"  class="colored-blue" checked="checked" type="radio">
                                                        <span class="text">商品</span>
                                                    </label>
                                                </div>
                                                <div class="radio" style="float:left; padding-right:12px;">
                                                    <label>
                                                        <input <?php if($recpos['rec_type'] == 2): ?> checked="checked" <?php endif; ?> name="rec_type" value="2" type="radio" class="colored-blue"  >
