<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\wamp64\www\shop\public/../application/admin\view\article\imglist.htm";i:1684232731;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1687179963;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1684912930;}*/ ?>
<!DOCTYPE html>
<html>
                                    ...
                                    <div class="flip-scroll">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <?php if(is_array($imgRes) || $imgRes instanceof \think\Collection || $imgRes instanceof \think\Paginator): $i = 0; $__LIST__ = $imgRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$img): $mod = ($i % 2 );++$i;?>
                                                <tr>
                                                    <th><img height="40" src="<?php echo $img; ?>"></th>
                                                    <td align="center">
                                                        <!--  当前控制器的edit方法传入一个id获取-->
                                                        <!--通过ajxs异步处理来删除 delimg(this)里的的this是把当前的元素传过去 -->
                                                        <a href="#"  onclick="delimg(this);"  id="<?php echo $img; ?>" class="btn btn-danger btn-sm shiny">
                                        ...
                                        <script type="text/javascript">
                                            function  delimg(tu){
                                                ...
                                                var url ="<?php echo url('delimg'); ?>";                  //请求的地址
