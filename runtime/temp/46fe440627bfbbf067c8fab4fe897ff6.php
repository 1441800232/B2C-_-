<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\wamp64\www\shop\public/../application/admin\view\category_words\list.htm";i:1684912930;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1697091390;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1697277080;}*/ ?>
    <!DOCTYPE html>
<html>
    ...
    <!-- /Sidebar Menu -->
            ...
            <div class="page-content">
                ...
                <div class="page-body">                   
                    ...
                    class="btn btn-sm btn-azure btn-addon"onClick="javascript:window.location.href = '<?php echo url('categoryWords/add'); ?>'">
                                ...
                                <div class="widget-body">
                                    <div class="flip-scroll">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <?php if(is_array($cwRes) || $cwRes instanceof \think\Collection || $cwRes instanceof \think\Paginator): $i = 0; $__LIST__ = $cwRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cw): $mod = ($i % 2 );++$i;?>
                                                <tr>
                                                    <td align="center"><?php echo $cw['id']; ?></td>
                                                    <td align="center"><?php echo $cw['word']; ?></td>
                                                    <!--target  在新的标签中打开-->
                                                    <td><a href="<?php echo $cw['link_url']; ?>" target="_blank"><?php echo $cw['link_url']; ?></a></td>
                                                    <td align="center">
                                                        <?php echo $cw['cate_name']; ?>
                                                    </td>
                                                    <td align="center">
                                                        <a href="<?php echo url('edit',array('id'=>$cw['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                            <i class="fa fa-edit"></i> 编辑
                                                        </a>
                                                        <!-- 用url 访问到控制器里的del的方法传递一个值下面的id   -->
                                                        <a href="#" onClick="warning('确实要删除吗', '<?php echo url('del',array('id'=>$cw['id'])); ?>')" class="btn btn-danger btn-sm shiny">
