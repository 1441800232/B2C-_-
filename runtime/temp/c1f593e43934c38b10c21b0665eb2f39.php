<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\wamp64\www\shop\public/../application/admin\view\goods\list.htm";i:1684912929;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1687179963;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1684912930;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <!-- /Sidebar Menu -->
            ...
            <div class="page-content">
                ...
                <div class="page-body">
                    ...
                    class="btn btn-sm btn-azure btn-addon"onClick="javascript:window.location.href = '<?php echo url('goods/add'); ?>'">
                                            ...
                                            <?php if(is_array($goodsRes) || $goodsRes instanceof \think\Collection || $goodsRes instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($i % 2 );++$i;?>
                                               <tr>
                                                   ...
                                                   <td align="center">
                                                       ...
                                                       <img src="__UPADMIN__/<?php echo $goods['sm_thumb']; ?>" height="30">
                                                       <?php else: ?>
                                                       暂无主图
                                                       <?php endif; ?>
                                                   </td>
                                                   ...
                                                   <td align="center"><?php if($goods['on_sale'] == 1): ?>已上架<?php else: ?>未上架<?php endif; ?></td>
                                                   <td align="center">
                                                   <?php if($goods['cate_name']): ?>
                                                   <?php echo $goods['cate_name']; else: ?>未设置
                                                   <?php endif; ?>
                                                   </td>
                                                   <td align="center">
                                                       <?php if($goods['brand_name']): ?>
                                                       <?php echo $goods['brand_name']; else: ?>未设置
                                                       <?php endif; ?>
                                                   </td>
                                                   <td align="center">
                                                       <?php if($goods['type_name']): ?>
                                                       <?php echo $goods['brand_name']; else: ?>未设置
                                                       <?php endif; ?>
                                                   </td>
                                                   <td align="center"><?php echo $goods['goods_weight']; ?></td>
                                                   <td align="center"><?php echo $goods['weiht_uint']; ?></td>
                                                   <td align="center"><?php if($goods['gn']): ?><?php echo $goods['gn']; else: ?>0<?php endif; ?></td>
                                                   <td align="center">
                                                   <a href="<?php echo url('inventory',array('id'=>$goods['id'])); ?>" class="btn btn-primary btn-darkorange btn-sm shiny">
