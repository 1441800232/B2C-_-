<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\wamp64\www\shop\public/../application/admin\view\brand\list.htm";i:1684232731;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1687179963;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1684912930;}*/ ?>
<!DOCTYPE html>
<html>
...
<!--                    </a>-->
    ...
    <!-- /Sidebar Menu -->
            ...
            <div class="page-content">
                ...
                <!-- Page Body -->
                <div class="page-body">                   
                    <button type="button" tooltip="添加品牌" 
                    class="btn btn-sm btn-azure btn-addon"onClick="javascript:window.location.href = '<?php echo url('Brand/add'); ?>'"> 
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <!--target  在新的标签中打开-->
                                                    <td><a href="<?php echo $brand['brand_url']; ?>"
                                                            target="_blank"><?php echo $brand['brand_url']; ?></a></td>
                                                    <td align="center">
                                                        <?php if($brand['brand_img'] != 0): ?>
                                                        <img src="__UPADMIN__/<?php echo $brand['brand_img']; ?>" height="50px">
                                                        <?php else: ?>
                                                        暂无图片
                                                        <?php endif; ?>
                                                    </td>                           <!-- | cut_str=###,15   使用公共文件里截取字段方法的方法-->
                                                    <td align="center"><?php echo cut_str($brand['brand_describe'],15); ?></td>
                                                    <td align="center">
                                                    ...
                                                    <td align="center">
                                                        <a href="<?php echo url('edit',array('id'=>$brand['id'])); ?>"
                                                            class="btn btn-primary btn-sm shiny">
                                                            <i class="fa fa-edit"></i> 编辑
                                                        </a>
                                                        <!-- 用url 访问到控制器里的del的方法传递一个值下面的id   -->
                                                        <a href="#"
                                                            onClick="warning('确实要删除吗', '<?php echo url('del',array('id'=>$brand['id'])); ?>')"
