...
<!--                            </div>-->
                            ...
                            <div class="item" id="email_yz" >
                                ...
                                <div class="item-info">
                                    ...
                                    <a href="javascript:void(0);" class="meswitch" ectype="meSwitch" data-type="email">点击注册时候请点击两下这里</a>
                                </div>
                                <div class="input-tip"></div>
                            </div>
                            ...
                            <div class="item" id="code_email" >
                                ...
                                <div class="item-info">
                                    ...
                                    <input type="button"  id="btn"  onclick="sendChangeEmail(1);" class="sms-btn"  value="获取验证码"  />
                                </div>
                                <div class="input-tip"></div>
                            </div>
