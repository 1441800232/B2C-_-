<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\wamp64\www\shop\public/../application/member\view\account\reg.htm";i:1686118506;}*/ ?>
    ...
    <div class="loginRegister-header">
        <div class="w w1200">
            <div class="logo">
                ...
                <div class="logo-span">
                    <b style="background:url(img/login_logo_pic.png) no-repeat;"></b>                </div>
            </div>
            <div class="header-href">
                <span>已注册可<a href="<?php echo url('account/login'); ?>" class="jump">在此登录</a></span>
            </div>
        </div>
    </div>
    <div class="container">
...
<!--                            <div class="item" id="phone_yz" style="display:none;">-->
...
<!--                                    &lt;!&ndash;                                    <a href="javascript:void(0);" class="meswitch" ectype="meSwitch" data-type="email">或手机验证</a>&ndash;&gt;-->
<!--                                </div>-->
<!--                                <div class="input-tip"></div>-->
<!--                            </div>-->
...
<!--                                    <input type="button"  id="zemail"  onclick="sendChangeEmail(this);" class="sms-btn"  value="获取验证码"  />-->
<!--                                </div>-->
<!--                                <div class="input-tip"></div>-->
<!--                            </div>-->

<!--                            <div class="item" id="code_mobile" style="display:none;" >-->
<!--                                <div class="item-label">短信验证码</div>-->
<!--                                <div class="item-info">-->
<!--                                    <input type="text" name="send_code"  class="text text-2 ignore" value="" autocomplete="off" />-->
<!--                                    <input type="button"  id="p-btn"  onclick="sendChangePhone(this)" class="sms-btn"  value="获取验证码"  />-->
<!--                                </div>-->
<!--                                <div class="input-tip"></div>-->
<!--                            </div>-->
                            ...
                            <div class="item" id="code_email" >
                                ...
                                <div class="item-info">
                                    <input type="text" name="send_code" id="send_code" class="text text-2 ignore" value="" autocomplete="off" />
                                    <input type="button"  id="zemail"  onclick="sendChangeEmail();" class="sms-btn"  value="获取验证码"  />                                </div>
                                <div class="input-tip"></div>
                            </div>
