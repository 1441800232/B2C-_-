<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"D:\wamp64\www\shop\public/../application/admin\view\category_brands\edit.htm";i:1684232731;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1684232731;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1684822925;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('categoryBrands/lst'); ?>">关联品牌管理</a>
                    </li>
                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                                        <!--   enctype意思是可以上传图片-->
                                        <input type="hidden" name="id" value="<?php echo $categoryBrands['id']; ?>" >
                                        <div class="form-group">
                                            <label for="username" class="col-sm-2 control-label no-padding-right">关联的顶级栏目</label>
                                            <div class="col-sm-6">
                                                <select name="category_id">
                                                    <option value="">请选择</option>
                                                    <?php if(is_array($cateRes) || $cateRes instanceof \think\Collection || $cateRes instanceof \think\Paginator): $i = 0; $__LIST__ = $cateRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?>
                                                    <!--获取和传输顶级栏目-->
                                                    <option <?php if($categoryBrands['category_id'] == $cate['id']): ?> selected="selected" <?php endif; ?> value="<?php echo $cate['id']; ?>"><?php echo $cate['cate_name']; ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="checkbox">
                                                    ...
                                                    if(is_array($brandRes) || $brandRes instanceof \think\Collection || $brandRes instanceof \think\Paginator): $i = 0; $__LIST__ = $brandRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$brand): $mod = ($i % 2 );++$i;
                                                    ...
                                                    <label style="margin-right: 15px;">
                                                        <input <?php echo $checked; ?> name="brands_id[]" value="<?php echo $brand['id']; ?>" type="checkbox" class="colored-blue">
                                        ...
                                        <div class="form-group">
                                            <label for="username" class="col-sm-2 control-label no-padding-right">推广图片</label>
                                            <div class="col-sm-6">
                                                <input name="pro_img" type="file">
                                                <?php if($categoryBrands['pro_img']): ?>
                                                <img src="__UPADMIN__/<?php echo $categoryBrands['pro_img']; ?>" height="30px">
                                                <?php else: ?>
                                                暂无推广图
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label for="username" class="col-sm-2  control-label no-padding-right">推广地址</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="" value="<?php echo $categoryBrands['pro_url']; ?>" name="pro_url" type="text">
                                            </div>
                                        </div>
