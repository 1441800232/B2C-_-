<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"D:\wamp64\www\shop\public/../application/admin\view\category_brands\list.htm";i:1684912929;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1687179963;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1684912930;}*/ ?>
    <!DOCTYPE html>
<html>
...
<!--                    </a>-->
    ...
    <!-- /Sidebar Menu -->
            ...
            <div class="page-content">
                ...
                <!-- Page Body -->
                <div class="page-body">                   
                    <button type="button" tooltip="添加关联词" 
                    class="btn btn-sm btn-azure btn-addon"onClick="javascript:window.location.href = '<?php echo url('categoryBrands/add'); ?>'">
                                        ...
                                        <table class="table table-bordered table-hover">
                                            <thead class="">
                                                <tr>
                                                    ...
                                                    <th>推广图片</th>
                                                    <th>推广图地址</th>
                                                    <th class="text-center" width="8%">关联栏目</th>
                                                    <th class="text-center">操作</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php if(is_array($cdRes) || $cdRes instanceof \think\Collection || $cdRes instanceof \think\Paginator): $i = 0; $__LIST__ = $cdRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cd): $mod = ($i % 2 );++$i;?>
                                                <tr>
                                                    <td align="center"><?php echo $cd['id']; ?></td>
                                                    <td align="center"><?php if($cd['brand_name']): ?>
                                                                       <?php echo $cd['brand_name']; else: ?>
                                                                       暂无关联品牌
                                                                       <?php endif; ?>
                                                    </td>
                                                    <td align="center">
                                                        <?php if($cd['pro_img']): ?>
                                                        <img src="__UPADMIN__/<?php echo $cd['pro_img']; ?>" height="30px">
                                                        <?php else: ?>
                                                        暂无推广图
                                                        <?php endif; ?>
                                                    </td>
                                                    <!--target  在新的标签中打开-->
                                                    <td><a href="<?php echo $cd['pro_url']; ?>" target="_blank"><?php echo $cd['pro_url']; ?></a></td>
                                                    <td align="center">
                                                        <?php echo $cd['cate_name']; ?>
                                                    </td>
                                                    <td align="center">
                                                        <a href="<?php echo url('edit',array('id'=>$cd['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                            <i class="fa fa-edit"></i> 编辑
                                                        </a>
                                                        <!-- 用url 访问到控制器里的del的方法传递一个值下面的id   -->
                                                        <a href="#" onClick="warning('确实要删除吗', '<?php echo url('del',array('id'=>$cd['id'])); ?>')" class="btn btn-danger btn-sm shiny">
