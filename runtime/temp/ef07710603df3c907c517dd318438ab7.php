<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\wamp64\www\shop\public/../application/admin\view\category_brands\add.htm";i:1684232731;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1684232731;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1684370942;}*/ ?>
<!DOCTYPE html>
<html>
                                    ...
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="checkbox">
                                                        ...
                                                        <label style="margin-right: 15px;">
                                                            <input name="brands_id[]" value="<?php echo $brand['id']; ?>" type="checkbox" class="colored-blue">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" placeholder="" name="pro_url" type="text">
                                                </div>
                                            </div>
