<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\wamp64\www\shop\public/../application/admin\view\auth_group\edit.htm";i:1697279542;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1697091390;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1697277080;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="<?php echo url('Index/index'); ?>">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('AuthGroup/lst'); ?>">用户组组管理</a>
                    </li>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" value="<?php echo $authGroups['title']; ?>"  placeholder="" name="title" required="" type="text">
                            </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="radio"   style="float: left; padding-left: 10px;">
                                    ...
                                    <label>
                                        ...
                                        <input
                                                <?php if($authGroups['status'] == 0): ?>
                                                checked="checked"  <?php endif; ?>
                                                type="radio" class="colored-blue" name="status" value="0">
