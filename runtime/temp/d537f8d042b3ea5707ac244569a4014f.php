<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\wamp64\www\shop\public/../application/admin\view\admin\list.htm";i:1697029035;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1697091390;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1697277080;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center">最后登入时间</th>
                        ...
                        <tbody>
                         <?php if(is_array($adminRes) || $adminRes instanceof \think\Collection || $adminRes instanceof \think\Paginator): $i = 0; $__LIST__ = $adminRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$admin): $mod = ($i % 2 );++$i;?>
                            <tr>
                                ...
                                <td align="center"><?php echo $admin['uname']; ?></td>
                                <td align="center"><?php echo date("Y-m-d H:i:s",$admin['create_time'] ); ?></td>
                                <td align="center"><?php echo date("Y-m-d H:i:s",$admin['last_time'] ); ?></td>
                                <td align="center">
                                    <label>
                                        <input id="<?php echo $admin['id']; ?>"
                                               <?php if($admin['status'] == 1): ?> checked="checked"
                                               <?php endif; if($admin['id'] == 1): ?>
                                                disabled="disabled"
                                                <?php endif; ?>
                                ...
                                <td align="center">
                                    ...
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('Admin/del',array('id'=>$admin['id'])); ?>')" class="btn btn-danger btn-sm shiny">
    ...
    <script type="text/javascript">
        function changestasus(o){
            ...
            $.ajax({
                ...
                dataType:'json',
                data:{id:id},
                url:"<?php echo url('Admin/changestasus'); ?>",
