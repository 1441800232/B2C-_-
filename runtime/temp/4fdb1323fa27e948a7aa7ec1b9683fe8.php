<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\wamp64\www\shop\public/../application/index\view\goods\goods.htm";i:1694939935;s:67:"D:\wamp64\www\shop\public/../application/index\view\common\head.htm";i:1694939809;s:69:"D:\wamp64\www\shop\public/../application/index\view\common\footer.htm";i:1694164482;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <script type = "text/javascript">
        var json_languages = {
            ...
            "Immediate_use": "\u7acb\u5373\u4f7f\u7528",
            "no_enabled": "\u5173\u95ed",
            "select_stages_number": "\u8bf7\u9009\u62e9\u5206\u671f\u671f\u6570",
            "store_subscribe": "\u9884\u7ea6\u5230\u5e97",
            "submit_subscribe": "\u63d0\u4ea4\u9884\u7ea6",
            "store_lately": "\u9009\u62e9\u79bb\u4f60\u6700\u8fd1\u7684\u95e8\u5e97",
            "see_store": "\u67e5\u770b\u95e8\u5e97",
            "select_base": "\u8bf7\u9009\u62e9\u5957\u9910\u57fa\u672c\u4ef6",
            "data_not_complete": "\u6570\u636e\u683c\u5f0f\u4e0d\u5b8c\u6574",
            "understock": "\u5e93\u5b58\u4e0d\u8db3\uff0c\u8bf7\u9009\u62e9\u5176\u4ed6\u5546\u54c1",
            "store_goods_null": "\u5f88\u62b1\u6b49\uff0c\u8be5\u533a\u57df\u6682\u65e0\u95e8\u5e97\u6709\u8d27\uff0c\u6b63\u52aa\u529b\u8865\u8d27\u4e2d\u2022\u2022\u2022",
            "please_message_input": "\u8bf7\u60a8\u586b\u5199\u7559\u8a00\u4fe1\u606f.",
            "been_evaluated": "\u60a8\u5df2\u8bc4\u4ef7\u8fc7."
        };
        //加载效果
    ...
    <link rel = "stylesheet" type = "text/css" href = "__index__/css/goods_fitting.css" />
    <link rel = "stylesheet" type = "text/css" href = "__index__/css/suggest.css" />
    <link rel = "stylesheet" type = "text/css" href = "__index__/js/calendar/calendar.min.css" />
    <link rel = "stylesheet" type = "text/css" href = "__index__/js/perfect-scrollbar/perfect-scrollbar.min.css" />
</head>
<script type="text/javascript">
    var ajax_add_to_cart ="<?php echo url('index/Flow/addToCart'); ?>";
    //购物车地址
    var catr_url ="<?php echo url('index/Flow/flow1'); ?>";
</script>
<body>
<!-- 头部 -->
        ...
        <div class = "product-info">
          <!--相册开始-->
            <div class = "preview" if = "preview">
                <div class = "gallery_wrap"><a href = "__uploads__/uploads/<?php echo $goodsInfo['og_thumb']; ?>" class = "MagicZoomPlus" id = "Zoomer"
                        ...
                        src = "__uploads__/uploads/<?php echo $goodsInfo['big_thumb']; ?>" id = "J_prodImg"
                        alt = ""></a>
                </div>
                <div class = "spec-list">
                    ...
                    <div class = "spec-items">
                        <ul>
                            <?php if(is_array($goodsPhotoRes) || $goodsPhotoRes instanceof \think\Collection || $goodsPhotoRes instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsPhotoRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mid_photo): $mod = ($i % 2 );++$i;?>
                            <li>
                                <a href = "__uploads__/uploads/<?php echo $mid_photo['og_photo']; ?>" rel = "zoom-id: Zoomer"
                                   rev = "__uploads__/uploads/<?php echo $mid_photo['big_photo']; ?>" >
                                    <img src = "__uploads__/uploads/<?php echo $mid_photo['mid_photo']; ?>" alt = "" width = "58" height = "58" />
                                </a>
                            </li>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                                ...
                                <div class = "summary-item si-coupon">
                                    ...
                                    <div class = "si-warp">
                                        <a class = "J-open-tb" href = "#none" data-goodsid = "799">
                                            <div class = "quan-item"><i class = "i-left"></i>满2000减100<i
                                                    class = "i-right"></i></div>
                                        </a>
                                        <a class = "J-open-tb" href = "#none" data-goodsid = "799">
                                            <div class = "quan-item"><i class = "i-left"></i>满1000减35<i
                                                    class = "i-right"></i></div>
                                        </a>
                                        <a class = "J-open-tb" href = "#none" data-goodsid = "799">
                                            <div class = "quan-item"><i class = "i-left"></i>满10000减500<i
                                                    class = "i-right"></i></div>
                                        </a>
                                        <a class = "J-open-tb" href = "#none" data-goodsid = "799">
                                            <div class = "quan-item"><i class = "i-left"></i>满10000减888<i
                                                    class = "i-right"></i></div>
                                        </a>
                                        <a class = "J-open-tb" href = "#none" data-goodsid = "799">
                                            <div class = "quan-item"><i class = "i-left"></i>满50000减5888<i
                                                    class = "i-right"></i></div>
                                        </a>
                                        <a class = "J-open-tb" href = "#none" data-goodsid = "799">
                                            <div class = "quan-item"><i class = "i-left"></i>满10减500<i
                                                    class = "i-right"></i></div>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class = "summary-basic-info">
                            ...
                            <style type="text/css">
                                ...
                                label.checkstaus i{
                                    ...
                                    background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAANSUhEUgAAAABhq6zVAAAAGXRFWHRTb2);
                                }
                            </style>

                            <!--单选属性开始-->
                            <?php if(is_array($radioAttrArr) || $radioAttrArr instanceof \think\Collection || $radioAttrArr instanceof \think\Paginator): $i = 0; $__LIST__ = $radioAttrArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$radioAttr): $mod = ($i % 2 );++$i;?>
                            <div class = "summary-item is-integral">
                                <div class = "si-tit"><?php echo $radioAttr[0]['attr_name'];?></div>
                                <div class="si-warp">
<!--                                    <label class="checkstaus"><input type="radio" checked="checked" name="color" value="黑色">黑色<i></i></label>-->
                                    <?php if(is_array($radioAttr) || $radioAttr instanceof \think\Collection || $radioAttr instanceof \think\Paginator): $i = 0; $__LIST__ = $radioAttr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$attr): $mod = ($i % 2 );++$i;?>
                                    <label <?php if($i == 1): ?>  class="checkstaus" <?php endif; ?> >
                                        <input <?php if($i == 1): ?>  checked="checkstaus" <?php endif; ?> type="radio" name="attr_<?php echo $attr['attr_id']; ?>" value="<?php echo $attr['id']; ?>"/>
                                        <?php echo $attr['attr_value']; if($attr['attr_price'] > 0): ?>[加<?php echo $attr['attr_price']; ?>元]<?php endif; if($attr['attr_price'] < 0): ?>[减<?php echo $attr['attr_price']*-1; ?>元]<?php endif; ?>
                                    <i></i>
                                    </label>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </div>
                            ...
                            <script type="text/javascript">
                                ...
                                $(".si-warp label").click(function (){
                                    $(this).addClass('checkstaus').siblings().removeClass('checkstaus');
                            ...
                            <div class = "summary-item is-number">
                                ...
                                <div class = "si-warp">
                                    <div class = "amount-warp">
                                        <input class = "text buy-num" ectype = "quantity" value = "1" name = "number"
                                               defaultnumber = "1">
                                        <div class = "a-btn">
                                            ...
                                            <input type = "hidden" name = "perNumber" id = "perNumber"
                                                   ectype = "perNumber" value = "0">
                                            <input type = "hidden" name = "perMinNumber" id = "perMinNumber"
                                                   ectype = "perMinNumber" value = "1">
                                        </div>
                                        <input name = "confirm_type" id = "confirm_type" type = "hidden" value = "3" />
                                    </div>
                                    <span>库存&nbsp;<em id = "goods_attr_num"
                                                        ectype = "goods_attr_num"></em>&nbsp;个</span>
                                </div>
                            </div>
                            <div class = "clear"></div>
                        </div>
                        <div class = "choose-btns ml60 clearfix">
                            <a href = "javascript:bool=0;addToCart(<?php echo $goodsInfo['id']; ?>)" data-type = "0" class = "btn-buynow"
                               ectype = "btn-buynow">立即购买</a>
                            <a href = "javascript:bool=0;addToCartShowDiv(<?php echo $goodsInfo['id']; ?>);"  class = "btn-append"
                               ectype = "btn-append"><i class = "iconfont icon-carts"></i>加入购物车</a>
                        ...
                        <ul>
                            <li>
                                <div class = "p-img"><a href = "goods.php?id=635" target = "_blank"
                                        ...
                                        src = "__index__/img/0_thumb_G_1489102950633.jpg" width = "140" height = "140"></a>
                                </div>
                            ...
                            <li>
                                <div class = "p-img"><a href = "goods.php?id=634" target = "_blank"
                                        ...
                                        src = "__index__/img/0_thumb_G_1489102753231.jpg" width = "140" height = "140"></a>
                                </div>
                                <div class = "p-name"><a href = "goods.php?id=634" target = "_blank"
                                                         title = "新款韩版chic学生宽松短款外套上衣字母长袖连帽套头卫衣女潮">新款韩版chic学生宽松短款外套上衣字母长袖连帽套头卫衣女潮</a>
                                </div>
                                <div class = "price">
                                    <em>¥</em>300.00
                                </div>
                            ...
                            <li>
                                <div class = "p-img"><a href = "goods.php?id=864" target = "_blank"
                                        ...
                                        src = "__index__/img/0_thumb_G_1490211620029.jpg" width = "140" height = "140"></a>
                                </div>
                            ...
                            <li>
                                <div class = "p-img"><a href = "goods.php?id=785" target = "_blank"
                                        ...
                                        src = "__index__/img/0_thumb_G_1490174208112.jpg" width = "140" height = "140"></a>
                                </div>
                                <div class = "p-name"><a href = "goods.php?id=785" target = "_blank"
                                                         title = "森马夹克 2016冬装新款男士飞行夹克贴布绣立领休闲外套韩版潮流">森马夹克
                                                                                                                               2016冬装新款男士飞行夹克贴布绣立领休闲外套韩版潮流</a>
                                </div>
                                <div class = "price">
                                    <em>¥</em>199.90
                                </div>
                            ...
                            <li>
                                <div class = "p-img"><a href = "goods.php?id=625" target = "_blank"
                                                        title = "秋季新款男士套头卫衣印花外套韩版简约百搭潮流男生上衣服"><img
                                        src = "__index__/img/0_thumb_G_1489099437211.jpg" width = "140" height = "140"></a>
                                </div>
                                <div class = "p-name"><a href = "goods.php?id=625" target = "_blank"
                                                         title = "秋季新款男士套头卫衣印花外套韩版简约百搭潮流男生上衣服">秋季新款男士套头卫衣印花外套韩版简约百搭潮流男生上衣服</a>
                                </div>
                                <div class = "price">
                                    <em>¥</em>120.00
                                </div>
                                    ...
                                    <ul>
                                        <li>
                                            <div class = "p-img"><a href = "goods.php?id=864"
                                                                    title = "马克华菲长袖T恤男士圆领修身韩版刺绣纯棉2017春装新款潮t 7002 立体3D绣花 欧美潮流范 17春装新品"><img
                                                    src = "__index__/img/0_thumb_G_1490211620029.jpg" width = "130"
                                                    height = "130"></a></div>
                                        ...
                                        <li>
                                            <div class = "p-img"><a href = "goods.php?id=863"
                                                                    title = "马克华菲长袖T恤男 冬季新品纯棉圆领黑白潮款印花休闲t恤   98"><img
                                                    src = "__index__/img/0_thumb_G_1490211575591.jpg" width = "130"
                                                    height = "130"></a></div>
                                            <div class = "p-name"><a href = "goods.php?id=863"
                                                                     title = "马克华菲长袖T恤男 冬季新品纯棉圆领黑白潮款印花休闲t恤   98">马克华菲长袖T恤男
                                                                                                                                          冬季新品纯棉圆领黑白潮款印花休闲t恤
                                                                                                                                          98</a>
                                            </div>
                                            <div class = "p-price">
                                        ...
                                        <li>
                                            <div class = "p-img"><a href = "goods.php?id=865"
                                                    ...
                                                    src = "__index__/img/0_thumb_G_1490211700709.jpg" width = "130"
                                                    height = "130"></a></div>
                            ...
                            <ul>
                                <li>
                                    <div class = "p-img"><a href = "goods.php?id=799" target = "_blank"
                                            ...
                                            src = "__index__/img/0_thumb_G_1490174858999.jpg" width = "170"
                                            height = "170"></a></div>
                                    <div class = "p-name"><a href = "goods.php?id=799" target = "_blank">韩美格2017春秋新款修身大码蕾丝网纱打底衫女长袖薄款圆领女T恤
                                                                                                         全店商品 二件减5元
                                                                                                         三件减10</a>
                                    </div>
                                    <div class = "p-lie">
                                ...
                                <li>
                                    <div class = "p-img"><a href = "goods.php?id=626" target = "_blank"
                                            ...
                                            src = "__index__/img/0_thumb_G_1489099544749.jpg" width = "170"
                                            height = "170"></a></div>
                                    <div class = "p-name"><a href = "goods.php?id=626" target = "_blank">秋冬新款加绒圆领套头卫衣男青年男生韩版潮流学生休闲外套男</a>
                                    </div>
                                    <div class = "p-lie">
                                        <div class = "p-price">
                                            <em>¥</em>168.00
                                ...
                                <li>
                                    <div class = "p-img"><a href = "goods.php?id=865" target = "_blank"
                                                            title = "美特斯邦威长袖T恤男士2017春装新款时尚印花百搭205064商场同款 1元秒100元优惠券丨限量抢丨立即抢购"><img
                                            src = "__index__/img/0_thumb_G_1490211700709.jpg" width = "170"
                                            height = "170"></a></div>
                                ...
                                <li>
                                    <div class = "p-img"><a href = "goods.php?id=775" target = "_blank"
                                            ...
                                            src = "__index__/img/0_thumb_G_1490169281436.jpg" width = "170"
                                            height = "170"></a></div>
                                ...
                                <li>
                                    <div class = "p-img"><a href = "goods.php?id=768" target = "_blank"
                                            ...
                                            src = "__index__/img/0_thumb_G_1490169030833.jpg" width = "170"
                                            height = "170"></a></div>
                ...
                <div class = "gm-floors" ectype = "gm-floors">
                    <div class = "gm-f-item gm-f-details" ectype = "gm-item">
                        ...
                        <div class = "goods-para-list">
                            <dl class = "goods-para">
                               <?php if(is_array($uniAttrArr) || $uniAttrArr instanceof \think\Collection || $uniAttrArr instanceof \think\Paginator): $i = 0; $__LIST__ = $uniAttrArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$uniAttr): $mod = ($i % 2 );++$i;?>
                                <dd class = "column"><span><?php echo $uniAttr['attr_name']; ?>: <?php echo $uniAttr['attr_value']; ?></span></dd>
                               <?php endforeach; endif; else: echo "" ;endif; ?>
                            </dl>
                ...
                <ul>
                    <li>
                        <div class = "p-img"><a href = "goods.php?id=684" target = "_blank"><img
                                src = "__index__/img/0_thumb_G_1489109583798.jpg" width = "134" height = "134"></a>
                        </div>
                        <div class = "p-name"><a href = "goods.php?id=684" target = "_blank">【情侣款】Camel骆驼男靴
                                                                                             时尚潮流英伦风马丁靴高帮皮靴
                                                                                             爆卖1万双！ 情侣马丁靴
                                                                                             好评如潮</a></div>
                    ...
                    <li>
                        <div class = "p-img"><a href = "goods.php?id=685" target = "_blank"><img
                                src = "__index__/img/0_thumb_G_1489109633806.jpg" width = "134" height = "134"></a>
                        </div>
                        <div class = "p-name"><a href = "goods.php?id=685" target = "_blank">春季马丁靴男真皮男靴黄靴工装军靴韩版短靴沙漠靴高帮男鞋大黄靴
                                                                                             头层牛皮</a></div>
                        <div class = "p-price"><em>¥</em>1000.00</div>
                    </li>
                    <li>
                        <div class = "p-img"><a href = "goods.php?id=679" target = "_blank"><img
                                src = "__index__/img/0_thumb_G_1489108999364.jpg" width = "134" height = "134"></a>
                        </div>
                        <div class = "p-name"><a href = "goods.php?id=679" target = "_blank">特步女鞋2017春季新款运动鞋休闲鞋女慢跑步鞋旅游鞋轻便舒适时尚
                                                                                             早春特惠 爆款休闲女鞋
                                                                                             赠运费险</a></div>
                    ...
                    <li>
                        <div class = "p-img"><a href = "goods.php?id=634" target = "_blank"><img
                                src = "__index__/img/0_thumb_G_1489102753231.jpg" width = "134" height = "134"></a>
                        </div>
                        <div class = "p-name"><a href = "goods.php?id=634" target = "_blank">新款韩版chic学生宽松短款外套上衣字母长袖连帽套头卫衣女潮</a>
                        </div>
                        <div class = "p-price"><em>¥</em>300.00</div>
                    </li>
                    <li>
                        <div class = "p-img"><a href = "goods.php?id=683" target = "_blank"><img
                                src = "__index__/img/0_thumb_G_1489109337889.jpg" width = "134" height = "134"></a>
                        </div>
                        <div class = "p-name"><a href = "goods.php?id=683" target = "_blank">igtt铝框行李箱拉杆箱旅行箱万向轮男女20/24/26寸密码箱登机箱子
                                                                                             铝合金框 加强密码锁 万向轮
                                                                                             终身保修</a></div>
        ...
        <div class = "ecsc-cart-popup" id = "addtocartdialog">
            ...
            <div class = "loading">
                <div class = "center_pop_txt">
                    <div class = "title"><h3>提示</h3><a href = "javascript:loadingClose();" title = "关闭"
...
<script type = "text/javascript" src = "__index__/js/magiczoomplus.js"></script>
<script type = "text/javascript" src = "__index__/js/cart_quick_links.js"></script>
<script type = "text/javascript" src = "__index__/js/calendar.php?lang="></script>
...
<script type = "text/javascript" src = "__index__/js/goodsFittings.js"></script>
<script type="text/javascript">
