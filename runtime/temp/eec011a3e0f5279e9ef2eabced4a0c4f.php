<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"D:\wamp64\www\shop\public/../application/admin\view\link\list.htm";i:1684232731;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1697091390;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1697277080;}*/ ?>
    <!DOCTYPE html>
<html>
    ...
    <!-- /Sidebar Menu -->
            ...
            <div class="page-content">
                ...
                <div class="page-body">                   
                    ...
                    class="btn btn-sm btn-azure btn-addon"onClick="javascript:window.location.href = '<?php echo url('Link/add'); ?>'">
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <?php if($link['link_logo'] != 0): ?>
                                                        <img src="__UPADMIN__/<?php echo $link['link_logo']; ?>" height="30px">
                                                        <?php else: ?>
                                                        暂无图片
                                                        <?php endif; ?>
                                                    </td>                           <!-- | cut_str=###,15   使用公共文件里截取字段方法的方法-->
                                                    <td align="center"><?php echo cut_str($link['description'],15); ?></td>
                                                    <td align="center"><?php echo cut_str($link['description'],15); ?></td>
                                                    <td align="center">
