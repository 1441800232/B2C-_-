<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\wamp64\www\shop\public/../application/admin\view\auth_rule\add.htm";i:1697103488;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1697091390;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1697098256;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="pid" style="width: 100%;">
                                    ...
                                    <option selected="selected" value="<?php echo $rule['id']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="radio"   style="float: left; padding-left: 10px;">
                                    <label>
                                        <input type="radio" class="colored-blue" checked="checked" name="status" value="1">
                                        <span class="text"> 是 </span>
                                    </label>
                                    <label>
                                        <!--和默认做一个比对  如果当前的这条记录value的默认值等于$v1，所以说明$v1就是默认值-->
                                        <input type="radio" class="colored-blue" name="status" value="0">
