<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\wamp64\www\shop\public/../application/admin\view\category_ad\list.htm";i:1684316445;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1684920272;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1684912930;}*/ ?>
    <!DOCTYPE html>
<html>
...
<!--                    </a>-->
    ...
    <!-- /Sidebar Menu -->
            ...
            <div class="page-content">
                ...
                <!-- Page Body -->
                <div class="page-body">                   
                    <button type="button" tooltip="添加关联图片   "
                    class="btn btn-sm btn-azure btn-addon"onClick="javascript:window.location.href = '<?php echo url('categoryAd/add'); ?>'">
                                ...
                                <div class="widget-body">
                                    <div class="flip-scroll">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <?php if(is_array($caRes) || $caRes instanceof \think\Collection || $caRes instanceof \think\Paginator): $i = 0; $__LIST__ = $caRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ca): $mod = ($i % 2 );++$i;?>
                                                <tr>
                                                    <td align="center"><?php echo $ca['id']; ?></td>
                                                    <td align="center">
                                                        <?php echo $ca['position']; ?>
                                                    </td>
                                                    <td align="center">
                                                        <?php if($ca['img_src']): ?>
                                                        <img src="__UPADMIN__/<?php echo $ca['img_src']; ?>" height="30px">
                                                        <?php else: ?>
                                                        暂无推广图
                                                        <?php endif; ?>
                                                    </td>
                                                    <!--target  在新的标签中打开-->
                                                    <td><a href="<?php echo $ca['link_url']; ?>" target="_blank"><?php echo $ca['link_url']; ?></a></td>
                                                    <td align="center">
                                                        <?php echo $ca['cate_name']; ?>
                                                    </td>
                                                    <td align="center">
                                                        <a href="<?php echo url('edit',array('id'=>$ca['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                            <i class="fa fa-edit"></i> 编辑
                                                        </a>
                                                        <!-- 用url 访问到控制器里的del的方法传递一个值下面的id   -->
                                                        <a href="#" onClick="warning('确实要删除吗', '<?php echo url('del',array('id'=>$ca['id'])); ?>')" class="btn btn-danger btn-sm shiny">
