<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"D:\wamp64\www\shop\public/../application/index\view\flow\flow4.htm";i:1695464379;s:69:"D:\wamp64\www\shop\public/../application/index\view\common\footer.htm";i:1694164482;}*/ ?>
...
<body class="bg-ligtGary">
	...
	<div class="dsc-choie dsc-cm" ectype="dsc-choie">
		...
		<span class="ui-areamini-text" data-id="1" title="蚌埠">蚌埠</span>
	</div>
	<div class="dorpdown-layer" ectype="dsc-choie-content">
                        	</div>
</div>
            <div class="txt-info" id="ECS_MEMBERZONE">
                <span>您好 &nbsp;<a href="user.php">67687527-70118</a></span>
            ...
            <div class="payOrder-warp" id="pay_main">
                <div class="payOrder-desc">
                    <div class="pay-top">
                        ...
                        <div class="pay-total">
                            <span>应付总额：</span>
                            <div class="pay-price">￥<?php echo $orderInfo['order_total_price']; ?></div>
                        </div>
                    </div>
                    <div class="pay-txt">
                        <p>订单号：<em id="nku"><?php echo $orderInfo['out_trade_no']; ?></em></p>
                        <p>您选定的支付方式为：<span id="paymode"><?php if($orderInfo['payment'] == 1): ?>支付宝<?php else: ?>微信 <?php endif; ?> </span></p>
            	                    <p>配送方式: <span id="express"><?php echo $orderInfo['distribution']; ?></span></p>
                            </div>
    <div class="o-list">
                        <div class="o-list-info">
                            <span id="shdz">寄送至：<?php echo $orderInfo['province']; ?> <?php echo $orderInfo['city']; ?> <?php echo $orderInfo['country']; ?> &nbsp;&nbsp;<?php echo $orderInfo['address']; ?></span>
                            <span id="shr">收货人：<?php echo $orderInfo['name']; ?></span>
                            <span id="mobile"><?php echo $orderInfo['phone']; ?></span>
                        </div>
                    </div>
                    <style type="text/css">
                        .paybtn{
