<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\wamp64\www\shop\public/../application/admin\view\auth_rule\edit.htm";i:1697275033;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1697091390;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1697277080;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="<?php echo url('Index/index'); ?>">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('AuthRule/lst'); ?>">规则管理</a>
                    </li>
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">修改规则</span>
            </div>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal"  action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="pid" style="width: 100%;">
                                    ...
                                    <option <?php if($rules['pid'] == $rule['id']): ?> selected="selected" <?php endif; ?> value="<?php echo $rule['id']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" value="<?php echo $rules['title']; ?>" placeholder="" name="title" required="" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control"value="<?php echo $rules['name']; ?>"  name="name" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                                ...
                                <div class="radio"   style="float: left; padding-left: 10px;">
                                    <label>
                                        <input type="radio"   class="colored-blue"
                                               <?php if($rules['status'] == 1): ?> checked="checked"<?php endif; ?>
                                               name="status" value="1">
                                    ...
                                    <label>
                                        ...
                                        <input type="radio"
                                               <?php if($rules['status'] == 0): ?> checked="checked"<?php endif; ?>
                                        class="colored-blue" name="status" value="0">
