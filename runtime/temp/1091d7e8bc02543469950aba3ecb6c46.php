<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"D:\wamp64\www\shop\public/../application/admin\view\category\add.htm";i:1684912930;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1697091390;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1697277080;}*/ ?>
<!DOCTYPE html>
<html>
                                    ...
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="username"
                                                    class="col-sm-2 control-label no-padding-right">上级分类</label>
                                                <div class="col-sm-6">
                                                        ...
                                                        <select class="form-control" name="pid">
                                                            ...
                                                            <?php echo str_repeat('--',  $cate['level']*6)?><?php echo $cate['cate_name']; ?></option>
                                            ...
                                            <div class="form-group">
                                                <label for="username" class="col-sm-2 control-label no-padding-right">分类名称
                                                </label>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" id="cate_name" placeholder="" name="iconfont"  type="text">
                                                </div>
                                                <p class="help-block col-sm-4 red">* 必填</p>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="radio" style="float:left; padding-right:12px;">
                                                        <label>
                                                            <input name="show_cate" value="1" type="radio" class="inverted">
                                                            <span class="text">是 </span>
                                                        </label>
                                                    </div>
                                                    <div class="radio" style="float:left; padding-right:12px;">
                                                        <label>
                                                            <input name="show_cate" value="0" type="radio" class="inverted" checked="checked" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="checkbox">
                                                        <?php if(is_array($CategoryRecposRes) || $CategoryRecposRes instanceof \think\Collection || $CategoryRecposRes instanceof \think\Paginator): $i = 0; $__LIST__ = $CategoryRecposRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$recpos): $mod = ($i % 2 );++$i;?>
                                                        <label style="margin-left: 10px">
                                                            <input  type="checkbox"  name="recpos[]"  value="<?php echo $recpos['id']; ?>"  class="inverted" >
