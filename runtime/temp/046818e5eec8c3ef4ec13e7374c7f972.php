<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\wamp64\www\shop\public/../application/admin\view\alternate_img\list.htm";i:1687226308;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1694164483;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1684912930;}*/ ?>
<!DOCTYPE html>
<html>
...
<!--                    </a>-->
    ...
    <!-- /Sidebar Menu -->
            ...
            <div class="page-content">
                ...
                <!-- Page Body -->
                <div class="page-body">                   
                    <button type="button" tooltip="添加轮播图" 
                    class="btn btn-sm btn-azure btn-addon"onClick="javascript:window.location.href = '<?php echo url('alternate_img/add'); ?>'">
                                ...
                                <div class="widget-body">
                                    <div class="flip-scroll">
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <?php if(is_array($alternate_imgRes) || $alternate_imgRes instanceof \think\Collection || $alternate_imgRes instanceof \think\Paginator): $i = 0; $__LIST__ = $alternate_imgRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$alternate): $mod = ($i % 2 );++$i;?>
                                                <tr>
                                                    <td align="center"><?php echo $alternate['id']; ?></td>
                                                    <td align="center"><input type="text" name="sort[<?php echo $alternate['id']; ?>]" value="<?php echo $alternate['sort']; ?>" style="width: 60px ; text-align: center"></td>
                                                    <td align="center"><?php echo $alternate['title']; ?></td>
                                                    <!--target  在新的标签中打开-->
                                                    <td><a href="<?php echo $alternate['link_url']; ?>"
                                                            target="_blank"><?php echo $alternate['link_url']; ?></a></td>
                                                    <td align="center">
                                                        <?php if($alternate['img_src'] != 0): ?>
                                                        <img src="__UPADMIN__/<?php echo $alternate['img_src']; ?>" height="50px">
                                                        <?php else: ?>
                                                        暂无图片
                                                        <?php endif; ?>
                                                    </td>
                                                    <td align="center">
                                                        <?php if($alternate['status'] != 0): ?>
                                                        开启
                                                        <?php else: ?> 
                                                        关闭
                                                    ...
                                                    <td align="center">
                                                        <a href="<?php echo url('edit',array('id'=>$alternate['id'])); ?>"
                                                            class="btn btn-primary btn-sm shiny">
                                                            <i class="fa fa-edit"></i> 编辑
                                                        </a>
                                                        <!-- 用url 访问到控制器里的del的方法传递一个值下面的id   -->
                                                        <a href="#"
                                                            onClick="warning('确实要删除吗', '<?php echo url('del',array('id'=>$alternate['id'])); ?>')"
                                                ...
                                                <tr>
                                                    <td style="padding-left: 10.4%" colspan="7">
                                                        <input class="btn btn-sm btn-azure btn-addon" type="submit" value="排序">
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <!-- render 分页-->
                                    <?php echo $alternate_imgRes->render(); ?>
                                    <div>
                                    </div>
                                </div>
                            </div>
