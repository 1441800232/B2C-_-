<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"D:\wamp64\www\shop\public/../application/admin\view\attr\list.htm";i:1684232731;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1687179963;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1684912930;}*/ ?>
<!DOCTYPE html>
<html>
...
<!--                    </a>-->
    ...
    <!-- /Sidebar Menu -->
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                         ...
                         转跳到首页
                           -->
                            <a href="<?php echo url('Type/lst'); ?>">商品类型</a>
                        </li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
                <!-- Page Body -->
                <div class="page-body">                   
                    <button type="button" tooltip="添加商品属性" 
                    class="btn btn-sm btn-azure btn-addon"onClick="javascript:window.location.href = '<?php echo url('attr/add'); ?>'">
                                ...
                                <div class="widget-body">
                                    <div class="flip-scroll">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <?php if(is_array($attrRes) || $attrRes instanceof \think\Collection || $attrRes instanceof \think\Paginator): $i = 0; $__LIST__ = $attrRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$attr): $mod = ($i % 2 );++$i;?>
                                                <tr>
                                                    <td align="center"><?php echo $attr['id']; ?></td>
                                                    <td align="center"><?php echo $attr['attr_name']; ?></td>
                                                    ...
                                                    <td align="center"><?php echo $attr['type_name']; ?></td>
                                                    <td align="center"><?php echo $attr['attr_values']; ?></td>

                                                    <td align="center">

                                                        <a href="<?php echo url('edit',array('id'=>$attr['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                            <i class="fa fa-edit"></i> 编辑
                                                        </a>
                                                        <!-- 用url 访问到控制器里的del的方法传递一个值下面的id   -->
                                                        <a href="#"
                                                            onClick="warning('确实要删除吗', '<?php echo url('del',array('id'=>$attr['id'])); ?>')"
