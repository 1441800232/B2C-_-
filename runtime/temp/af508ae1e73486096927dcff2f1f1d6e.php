<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\wamp64\www\shop\public/../application/admin\view\category_ad\edit.htm";i:1684318433;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1684232731;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1684370942;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('categoryAd/lst'); ?>">关联图片管理</a>
                    </li>
                    <li class="active">修改关联图片</li>
                </ul>
            </div>
            <!-- /Page Breadcrumb -->
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-blue">
                                <span class="widget-caption">修改关联图片</span>
                            </div>
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                                        <!--   enctype意思是可以上传图片-->
                                        <input type="hidden" name="id" value="<?php echo $categoryAd['id']; ?>">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="category_id">
                                                    ...
                                                    <!--获取和传输顶级栏目-->
                                                    <option value="<?php echo $cate['id']; ?>" <?php if($categoryAd['category_id'] == $cate['id']): ?> selected="selected" <?php endif; ?> ><?php echo $cate['cate_name']; ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <?php if($categoryAd['img_src']): ?>
                                                <img src="__UPADMIN__/<?php echo $categoryAd['img_src']; ?>" height="30">
                                                <?php else: ?>
                                                暂无图片
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder=""  value="<?php echo $categoryAd['link_url']; ?>" name="link_url" type="text">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="username" class="col-sm-2 control-label no-padding-right">关联图片位置</label>
                                            <div class="col-sm-6">
                                                <select name="position">
                                                    <option value="">请选择</option>
                                                    <option <?php if($categoryAd['position'] == 'A'): ?> selected="selected" <?php endif; ?> value="A">A</option>
                                                    <option <?php if($categoryAd['position'] == 'B'): ?>  selected="selected" <?php endif; ?> value="B">B</option>
                                                    <option <?php if($categoryAd['position'] == 'C'): ?>  selected="selected" <?php endif; ?> value="A">C</option>
