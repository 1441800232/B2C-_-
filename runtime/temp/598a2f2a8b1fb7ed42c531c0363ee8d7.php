<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"D:\wamp64\www\shop\public/../application/admin\view\cate\edit.htm";i:1684232731;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1684232731;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1684370942;}*/ ?>
<!DOCTYPE html>
<html>
                                    ...
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" role="form" action="" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                        ...
                                                        <select class="form-control" name="pid">
                                                            ...
                                                            <!--  做一个判断 修改下级时候会显示他对应的上级栏目的名字id-->
                                                            <option
                                                             <?php if($cates['id'] == $cate['pid']): ?> selected="selected"   <?php endif; ?>
                                                             value="<?php echo $cate['id']; ?>"><?php echo str_repeat('--',  $cate['level']*6)?><?php echo $cate['cate_name']; ?></option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input value="<?php echo $cates['cate_name']; ?>" class="form-control" id="cate_name" name="cate_name" required="" type="text">
                                                </div>
                                                <p class="help-block col-sm-4 red">* 必填</p>
                                            </div>                               
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="radio" style="float:left; padding-right:12px;">
                                                        <label>
                                                            <input name="show_nav" value="1" type="radio" {if condition="$cates['show_nav'] eq 1 " checked="checked" {/if} >
                                                            <span class="text">是 </span>
                                                        </label>
                                                    </div>
                                                    <div class="radio" style="float:left; padding-right:12px;">
                                                        <label>
                                                            <input name="show_nav" value="" type="radio" class="inverted" checked="checked" {if condition="$cates['show_nav'] eq 0 " checked="checked" {/if} >
                                            ...
                                            <div class="form-group">
                                                <label for="username"
                                                    class="col-sm-2 control-label no-padding-right"value>关键词</label>
                                                <div class="col-sm-6">
                                                    <textarea class="form-control" name="keywords">
                                                        <?php echo $cates['keywords']; ?>
                                                    </textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
