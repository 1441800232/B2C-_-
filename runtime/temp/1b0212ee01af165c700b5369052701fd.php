<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"D:\wamp64\www\shop\public/../application/admin\view\article\list.htm";i:1684232731;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1684232731;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1684912930;}*/ ?>
<!DOCTYPE html>
<html>
...
<!--                    </a>-->
    ...
    <!-- /Sidebar Menu -->
            ...
            <div class="page-content">
                ...
                <!-- Page Body -->
                <div class="page-body">                   
                    <button type="button" tooltip="添加文章" class="btn btn-sm btn-azure btn-addon"onClick="javascript:window.location.href = '<?php echo url('add'); ?>'"> 
                                            ...
                                            <tbody>
                                                <?php if(is_array($artRes) || $artRes instanceof \think\Collection || $artRes instanceof \think\Paginator): $i = 0; $__LIST__ = $artRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$art): $mod = ($i % 2 );++$i;?>
                                                 <tr>
                                                    ...
                                                    <td ><?php echo cut_str($art['title'],10); ?></td>
                                                    <td align="center">
                                                        <?php if($art['thumb'] != 0): ?>
                                                        <img src="__UPADMIN__/<?php echo $art['thumb']; ?>" height="30px">
                                                        <?php else: ?>
                                                        暂无缩略图
                                                        <?php endif; ?>
                                                    </td>
