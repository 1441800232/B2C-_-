<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"D:\wamp64\www\shop\public/../application/admin\view\member_level\list.htm";i:1684232731;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1697091390;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1697277080;}*/ ?>
<!DOCml html>
<html>
...
<head>
    ...
    <meta http-equiv="Content-ml" content="text/html; charset=UTF-8">
    <!--Basic Styles-->
    ...
    <!--Beyond styles-->
    <link id="beyond-link" href="__admin__/style/beyond.css" rel="stylesheet" ml="text/css">
...
<!--                    </a>-->
    ...
    <!-- /Sidebar Menu -->
            ...
            <div class="page-content">
                ...
                <!-- Page Body -->
                <div class="page-body">                   
                    <button ml="button" tooltip="添加会员级别" 
                    class="btn btn-sm btn-azure btn-addon"onClick="javascript:window.location.href = '<?php echo url('memberLevel/add'); ?>'">
                                    ...
                                    <div class="flip-scroll">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td align="center"><?php echo $ml['id']; ?></td>
                                                    <td align="center"><?php echo $ml['level_name']; ?></td>
                                                    <td align="center"><?php echo $ml['bom_point']; ?></td>
                                                    <td align="center"><?php echo $ml['top_point']; ?></td>
                                                    <td align="center"><?php echo $ml['rate']; ?></td>
                                                    <td align="center">

                                                        <a href="<?php echo url('edit',array('id'=>$ml['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                            <i class="fa fa-edit"></i> 编辑
                                                        </a>
                                                        <!-- 用url 访问到控制器里的del的方法传递一个值下面的id   -->
                                                        <a href="#" onClick="warning('确实要删除吗', '<?php echo url('del',array('id'=>$ml['id'])); ?>')"
