<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\wamp64\www\shop\public/../application/admin\view\article\add.htm";i:1684232731;s:66:"D:\wamp64\www\shop\public/../application/admin\view\common\top.htm";i:1684232731;s:67:"D:\wamp64\www\shop\public/../application/admin\view\common\left.htm";i:1684370942;}*/ ?>
<!DOCTYPE html>
<html>
...
<!--                    </a>-->
                                    ...
                                    <div id="horizontal-form">
                                        ...
                                        <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                                                   ...
                                                   <select name="cate_id">
                                                    <option value="">选择栏目
                                                        <?php if(is_array($cateRes) || $cateRes instanceof \think\Collection || $cateRes instanceof \think\Paginator): $i = 0; $__LIST__ = $cateRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?>
                                                            <option <?php if($cate['allow_son'] == 0): ?>  disabled="disabled" <?php endif; ?> value="<?php echo $cate['id']; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="radio" style="float:left; padding-right:12px;">
                                                        <label>
                                                            <input name="show_top" value="1" type="radio">
                                                    ...
                                                    <div class="radio" style="float:left; padding-right:12px;">
                                                        <label>
                                                            <input name="show_top" value="0" type="radio" checked="checked" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <textarea class="form-control" name="descriptiom"></textarea>
                                                </div>
                                            </div>
    ...
    // editor.config.uploadImgServer = '/sys/sys/houses/upload'//配置上传到服务器地址
    //
